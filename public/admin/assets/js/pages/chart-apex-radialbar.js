var colors = ["#39afd1"],
    ...
    colors =
        ...
        ["#0acf97", "#727cf5"]),
    dataColors = $("#circle-angle-radial").data("colors"),
    options = {
        ...
        legend: {
            ...
            formatter: function (a, o) {
                return a + ":  " + o.w.globals.series[o.seriesIndex];
            },
    ...
    options =
        ...
        )).render(),
        {
            ...
            fill: {
                type: "image",
                image: { src: ["assets/images/small/small-2.jpg"] },
            },
            ...
            labels: ["Volatility"],
            responsive: [
                { breakpoint: 380, options: { chart: { height: 280 } } },
            ],
        }),
    colors =
        ((chart = new ApexCharts(
    ...
    options = {
        chart: { height: 330, type: "radialBar", toolbar: { show: !0 } },
        plotOptions: {
            radialBar: {
                startAngle: -135,
                endAngle: 225,
