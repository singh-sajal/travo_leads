        ...
        <div class="col-12">
            <div class="card card-h-100">
                <div class="card-header d-flex flex-wrap border-bottom border-dashed align-items-center gap-3">
                    <h4 class="header-title me-auto">All Packages</h4>
...
@section('javascripts')
    ...
    <script>
        document.addEventListener('click', function(e) {
            const toggleBtn = e.target.closest('.toggle-package');
            if (toggleBtn) {
                e.preventDefault();
                ...
                fetch("{{ route('admin.package.toggle') }}", {
                        method: "POST",
                        headers: {
    ...
    <script>
        document.addEventListener('click', function(e) {
            ...
            if (toggleBtn) {
                ...
                fetch("{{ route('admin.package.toggle_featured') }}", {
                        method: "POST",
                        headers: {
                            "X-CSRF-TOKEN": "{{ csrf_token() }}",
                            "Content-Type": "application/json",
